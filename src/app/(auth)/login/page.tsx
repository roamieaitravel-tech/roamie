          ...
          <div className="space-y-4">
            {tripCards.map((card, index) => (
              <motion.div
                ...
                className="bg-white bg-opacity-10 backdrop-blur-md border border-white border-opacity-20 rounded-xl p-4 cursor-pointer hover:bg-opacity-20 transition-all"
              >
