...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex bg-white">
      ...
      <div className="hidden lg:flex w-1/2 bg-[#004E89] flex-col justify-center items-center p-8 relative overflow-hidden">
        {/* Background gradient effect */}
        <div className="absolute inset-0 bg-gradient-to-b from-[#004E89] to-[#003366] opacity-50" />
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center p-6 sm:p-8 lg:p-12 overflow-y-auto max-h-screen">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
        ...
        >
          ...
          {/* Heading */}
          <h2 className="text-2xl sm:text-3xl font-bold text-[#1c1c1e] mb-8 text-center">
            Create your account
          </h2>
          ...
          {successMessage && (
            <motion.div
              initial={{ opacity: 0, y: -10 }}
              animate={{ opacity: 1, y: 0 }}
              className="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg flex items-gap-2"
            >
              <CheckCircle2 className="w-5 h-5 text-green-600 flex-shrink-0 mr-2" />
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 border-2 border-[#1c1c1e] text-[#1c1c1e] py-3 rounded-full font-semibold hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed mb-6"
          >
            {isGoogleLoading ? (
          ...
          <div className="mb-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-10 pr-4 py-3 border-2 rounded-lg font-medium placeholder-gray-400 focus:outline-none transition-colors ${
                  errors.fullName
                    ? "border-red-500 bg-red-50"
                    : "border-gray-200 focus:border-[#FF6B35] bg-white"
                }`}
              />
            </div>
            {errors.fullName && (
          ...
          <div className="mb-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="••••••••"
                className={`w-full pl-10 pr-12 py-3 border-2 rounded-lg font-medium placeholder-gray-400 focus:outline-none transition-colors ${
                  errors.password
                    ? "border-red-500 bg-red-50"
                    : "border-gray-200 focus:border-[#FF6B35] bg-white"
                }`}
