...
const travelModes = [
  ...
  },
  {
    icon: "🚂",
    title: "By Train",
    description: "Major rail networks + international trains, instant booking",
    tone: "bg-[#004E89]",
  },
  {
    icon: "🚢",
...
const travelers = [
  {
    name: "Alex 🇺🇸",
    details: "Destination: Maui | Dec 20-25",
    budget: "Budget: $1,500",
  ...
  {
    name: "Sarah 🇬🇧",
    details: "Destination: Maui | Dec 21-26",
    budget: "Budget: $1,800",
  ...
  {
    name: "Ryan 🇨🇦",
    details: "Destination: Maui | Dec 20-27",
    budget: "Budget: $1,200",
      ...
      <footer className="bg-[#1C1C1E]">
        <div className="mx-auto max-w-7xl px-4 py-16 text-white sm:px-6 lg:px-8">
          ...
          <div className="mt-12 border-t border-white/10 pt-6 text-sm text-white/65">
            <p>© 2025 Roamie. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </main>
