    ...
    const fetchDashboardData = async () => {
      try {
        ...
        const mockTrips: Trip[] = [
          {
            ...
            budget: 1500,
            status: "planning",
            image_url: "https://images.unsplash.com/photo-1537953773345-d172ccf13cf1?w=400&q=80",
          ...
          },
          {
            ...
            budget: 2200,
            status: "booked",
            image_url: "https://images.unsplash.com/photo-1502602898536-47ad22581b52?w=400&q=80",
        ...
        const calculatedStats: Stats = {
          ...
          totalSaved: mockTrips.reduce((sum, trip) => sum + (trip.budget * 0.25), 0), // Mock savings
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {trips.map((trip) => (
                  <TripCard
                    ...
                    transportTypes={trip.transport_types}
                    budgetUsed={trip.budget_used}
                  />
                ))}
              </div>
            )}
